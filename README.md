...
* Independent: Removal effect of a campaign assume the independency on the overall conversion probability, i.e. the removal of a campaign does not affect the effectiveness of other campaigns. It may not capture the synergistic effects or interactions between campaigns. 
